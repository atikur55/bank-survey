      ...
      <div class="card-header">
        <div class="row">
          ...
          <div class="col-lg-5" style="text-align:end;">
            <a style="color: #000;" href="{{url('create_zone')}}"><i data-feather="plus-square"></i></a>
          </div>
        </div>
      </div>
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table id="dataTableExample" class="table table-striped text-center">
            ...
            <tr>
              ...
              <td>
                 <a href="{{url('create_active_zone')}}/{{$zone->id}}" class="btn @php echo $zone->status == 0?'bg-maroon':'bg-blue'@endphp">
                  @php
              ...
              <td>
                <a style="color: #000;" href="{{url('create_edit_zone')}}/{{$zone->id}}"><i data-feather="edit"></i></a>
                <a style="color: #000;" href="{{url('create_delete_zone')}}/{{$zone->id}}"><i data-feather="trash"></i></a>
              </td>
            </tr>
            @php $i++; @endphp
            @endforeach
