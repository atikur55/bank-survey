...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <form action="{{url('employee_details_post')}}" method="POST">
                @csrf
                <div class="card">
                            ...
                            <div class="col-lg-12 mt-5">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="row">
                                                        <div class="col-md-3 col-12">
                                                            <label><input type="checkbox" name="ebd_profession" class="ebd_profession" value="1" /> Service
                                                            Holder</label>
                                                        </div>
                                                        <div class="col-md-3 col-12">
                                                            <label><input type="checkbox" name="ebd_profession" class="ebd_profession"
                                                                value="2" /> Businessman</label>
                                                        </div>
                                                        <div class="col-md-3 col-12">
                                                            <label><input type="checkbox" name="ebd_profession" class="ebd_profession" value="3" /> Self
                                                            Employed</label>
                                                        </div>
                                                        <div class="col-md-3 col-12">
                                                            <label><input type="checkbox" name="ebd_profession" class="ebd_profession" value="4" /> Other
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-12">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-12">
                                                                    <input type="number" name="land_phone" class="form-control">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-6 table-bordered pb-2 pt-2">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="salary_verify" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-6 table-bordered pb-2 pt-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 table-bordered pb-2 pt-2">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 col-12"><input type="text" name="field_name" class="form-control"></div>
                                ...
                                {{-- <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Company Name</td>
                                            <td colspan="4"><input type="text" name="company_name" class="form-control" /></td>
                                            <td colspan="3" style="text-align: left;">
                                                <div class="row">
                                                    <div class="col-6 border-right">
                                                        <label><input type="checkbox" name="ebd_company" class="ebd_company" value="1" /> YES</label>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <div class="col-6"><input type="number" name="year" class="form-control"></div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="row">
                                                    <div class="col-6 border-right">Month (s)</div>
                                                    <div class="col-6"><input type="number" name="month" class="form-control"></div>
                                                </div>
                                            </td>
                                            <td colspan="2">
                                                <div class="row">
                                                    <div class="col-6 border-right">No. of Employee</div>
                                                    <div class="col-6"><input type="number" name="employee" class="form-control"></div>
                                                </div>
                                            </td>
                                            <td colspan="3" style="text-align: left;">
                                                <div class="row">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="4"><input type="text" name="business" class="form-control"></td>
                                            <td colspan="3" style="text-align: left;">
                                                <div class="row">
                                                    <div class="col-6 border-right">
                                                        <label><input type="checkbox" name="ebd_nat_bus" class="ebd_nat_bus" value="1" /> YES</label>
                                        ...
                                        <tr>
                                            <td>Designation</td>
                                            <td colspan="4"><input type="text" name="designation" class="form-control"></td>
                                            <td colspan="3" style="text-align: left;">
                                                <div class="row">
                                                    <div class="col-6 border-right">
                                                        <label><input type="checkbox" name="ebd_designation" class="ebd_designation" value="1" />
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="4"><input type="text" name="salary_verify" class="form-control"></td>
                                            <td colspan="3" style="text-align: left;">
                                                <div class="row">
                                                    <div class="col-6 border-right">
                                                        <label><input type="checkbox" name="ebd_salVname" class="ebd_salVname" value="1" /> YES</label>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2"><input type="text" name="field_name" id="field_name" class="form-control"></td>
                                            <td colspan="2">Signature</td>
                                            <td><input type="text" name="signature" id="signature" class="form-control"></td>
                                        </tr>
                                    </tbody>
                                </table> --}}
                            </div>
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-lg-6">
                            <a href="{{url('/personal_ca_post')}}" class="btn btn-dark">Previous</a>
                            </div>
