...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <form class="form-group" action="{{url('ca_photo_post')}}" method="POST" enctype="multipart/form-data">
                @csrf
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="file" name="ca_multiple_photo[]" class="form-control" multiple>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
