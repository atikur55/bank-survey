...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <form action="{{url('ca_employment_photo_post')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="container">
                        <h3>Step 2: EMPLOYMENT PHOTO UPLOAD</h3>
                        <hr>
                        <div class="row">
                            <div class="col-12">
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <input type="file" name="ca_employment_photo[]" class="form-control" multiple>
                                    </div>
                                </div>
                            </div>
                        </div>
